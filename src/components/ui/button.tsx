...
function Button ({ className, variant, size, isLoading = false, asChild = false, ...props }: ButtonProps) {
  ...
  return <Comp data-slot="button" className={classHelper(buttonVariants({ variant, size, className }))} {...props} />;
}
